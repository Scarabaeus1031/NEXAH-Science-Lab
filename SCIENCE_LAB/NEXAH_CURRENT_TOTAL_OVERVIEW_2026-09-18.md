...
| Bereich | Heutige Rolle |
|---|---|
| NEXAH Research und Science Lab | Forschungsfragen, Experimente, Audits, Ergebnisse, negative Resultate und wissenschaftliche Grenzen |
| Orientation Language Specification | normative, implementationsunabhängige Semantik |
| NEXAH Framework und Kernel | begrenzte Implementierungen, Referenzanwendungen und technische Verträge |
| ORION | revisionsgebundene deterministische Strukturverarbeitung innerhalb seines zertifizierten Kerns |
| NEXAHEDRON | primärer Human-facing Research Demonstrator und begrenzter Workspace |
| Library, Experience und Editorial System | öffentliche Orientierung, Works und redaktionelle Vermittlung |
| Mission Control | aktuelle Quellenbindung, Status, Routing, Aktivierungsgrenzen und Rückkehr zum Gesamtbild |

Vorhanden sind unter anderem:

- veröffentlichte semantische Grundlagen;
- typisierte Records, Verträge und Validatoren;
- begrenzte ausführbare Vergleichs- und Replay-Pfade;
- nachvollziehbare positive, negative und unentscheidbare Ergebnisse;
- ein umfangreiches Forschungs-, Bild-, Text- und Instrumentenarchiv;
- mehrere Human-facing Oberflächen;
- explizite Claim-, Provenienz- und STOP-Grenzen.

Nicht etabliert sind:

- eine allgemeine integrierte NEXAH-Maschine;
- ein gemeinsamer produktionsreifer Capability-Vertrag;
...
Die faire technische Einordnung lautet daher:

```text
KOHÄRENTES METHODISCHES ÖKOSYSTEM
+ FUNKTIONIERENDE KOMPONENTEN UND TEILPFADE
+ AUSFÜHRBARE VISUELLE INSTRUMENTE
+ MENSCHLICHE CLAIM AUTHORITY
...
nicht verschiedene NEXAHs. Sie zeigen verschiedene Verantwortungen desselben
Ökosystems.

### Die vier öffentlichen Orte

Die öffentlich sichtbare Version-1-Karte reduziert die komplexere interne
Architektur bewusst auf vier verständliche Eingänge:

| Öffentlicher Ort | Funktion | Autoritative Quelle |
|---|---|---|
| [nexah.de](https://nexah.de) | öffentliche und intellektuelle Heimat; Einstieg, Library, Living Atlas, Laboratory und öffentliche Wege | [NEXAH-Experience](https://github.com/Scarabaeus1031/NEXAH-Experience) |
| [NEXAH Repository](https://github.com/Scarabaeus1031/NEXAH) | Research & Framework; Constitution, Orientation Language, Kernel, Anwendungen, Governance und langfristiger Forschungsrecord | `Scarabaeus1031/NEXAH` |
| [ORION](https://github.com/Scarabaeus1031/NEXAH-ORION) | zertifizierter deterministischer Core innerhalb seiner eingefrorenen Version-1-Grenze | `Scarabaeus1031/NEXAH-ORION` |
| [NEXAHEDRON](https://nexahedron.com) | öffentlicher Human-facing Research Demonstrator und begrenzter Workspace | [NEXAHEDRON Repository](https://github.com/Scarabaeus1031/NEXAHEDRON) |

Der öffentliche Weg lautet damit:

```text
nexah.de
  -> VERSTEHEN UND EINEN EINSTIEG WÄHLEN
  -> NEXAH REPOSITORY FÜR FRAMEWORK UND QUELLEN
  -> ORION FÜR DEN ZERTIFIZIERTEN STRUKTURELLEN CORE
  -> NEXAHEDRON FÜR EINE MENSCHLICH GEHALTENE SESSION
```

Die Pfeile sind Navigationswege und keine automatische Ausführungskette.
Besucher können an jeder Grenze anhalten. NEXAHEDRON kann bei `Rest` enden,
ohne ORION aufzurufen.

### Die vollständige Arbeitslandschaft

Hinter den vier öffentlichen Orten liegen zwei weitere notwendige Rollen:

| Repository oder Kontrollraum | Rolle | Öffentlichkeitsgrenze |
|---|---|---|
| NEXAH Mission Control | operative Wahrheit, Human-Owner-Routing, Status, Entscheidungen, Custody und Aktivierungsgates | privater Backstage-Kontrollraum; keine wissenschaftliche Quellenautorität |
| NEXAH Core / NEXAH | Framework, Semantik, Implementierung, Anwendungen, Library-Registry und langfristiger Forschungsrecord | öffentliches Research-&-Framework-Repository |
| NEXAH-ORION | deterministische Strukturverarbeitung und ORION-eigene Verträge | öffentlich, aber nur im zertifizierten Scope autoritativ |
| NEXAH Science Lab | Forschungsfragen, Preregistrierungen, Fixtures, Resultate, negative Befunde, Labreports und wissenschaftliche Intake-Custody | öffentlicher Evidenzraum; keine Produkt- oder Ökosystemautorität |
| NEXAHEDRON | Interaktion, Darstellung, transienter lokaler Zustand und explizite menschliche Bestätigung | öffentlicher Demonstrator; keine semantische oder wissenschaftliche Autorität |
| NEXAH-Experience | öffentliche Präsentation, Navigation, Library-Projektion, Living Atlas, Reading Spaces und Laboratory-Brücke | öffentliches Frontend; Präsentation ist keine wissenschaftliche Validierung |

Hinzu kommt ein eingefrorener ORION-Version-1-Checkout als lokale
Zertifizierungs- und Abhängigkeitsreferenz. Er ist keine weitere öffentliche
Systemrolle und kein zusätzliches Produkt.

### Was nexah.de gegenwärtig sagt

Die Website beschreibt NEXAH als **Orientation Ecosystem** und Orientation als
Disziplin für komplexe Systeme. Ihr konkretes Kartenbeispiel unterscheidet für
Mercator, Equal Earth und Azimuthal Equidistant jeweils:

```text
I  Information preserved
L  Information lost
A  Artifacts introduced
U  Outside declared scope
```

Damit übersetzt die öffentliche Seite denselben Kern wie Science Lab und
Orientation Language in eine unmittelbar verständliche Form: Keine Karte ist
die ganze Welt; Vergleich ist nicht Identität; Orientierung unterstützt
menschliches Urteil und ersetzt es nicht.

Die Website weist derzeit außerdem 61 katalogisierte Publikationen,
Orientation Language 1.0, Research & Applications, den Atlas of Atlases und
den experimentellen Zugang zu NEXAHEDRON aus. Diese Angaben gehören zur
öffentlichen Experience- und Library-Projektion. Sie sind keine Aussage über
61 wissenschaftlich validierte Ergebnisse.

### Frontstage und Backstage
...
PUBLIC FRONTSTAGE
  ...
  ORION Repository
  NEXAHEDRON
  Science Lab evidence records

PRIVATE BACKSTAGE
  Mission Control
  Owner decisions and activation gates
  intake routing and custody management
```

Mission Control darf auf die öffentlichen Quellen zeigen und ihren aktuellen
...
### Desk 01 — Portfolio und Bedeutung

Desk 01 bestätigte einen kohärenten persönlichen, visuellen, dokumentarischen
und methodischen Corpus. Das visuelle Werk ist nicht bloßer Schmuck: Es ist
Teil der Frage-, Navigations- und Vermittlungsarchitektur. Es wird dadurch aber
nicht automatisch zu wissenschaftlicher Evidenz oder einem öffentlichen
Produkt.

### Desk 02 — Custody und Versionierung

Desk 02 band physische Ablagen, Manifestzustände, Repository-Zugehörigkeit und
Versionslücken. Historische Ausführung und spätere Nichtaktivierung wurden als
verschiedene Ereignisse derselben Linie aufgelöst. Die heutige `CURRENT/`
Truth Surface führt diese Arbeit mit überprüfbaren Quellenbindungen fort.

### Desk 03 — Architektur und Integration

Desk 03 unterschied vorhandene Teile und getestete Teilbaugruppen von einer
nicht etablierten Gesamtmaschine:

```text
PARTS INVENTORY                     EXISTS
TESTED SUBASSEMBLIES                EXIST
PROFILE-BOUND EXECUTABLE PATHS      EXIST
PARTIAL WIRING                      EXISTS
SHARED CONTROL UNIT                 NOT ESTABLISHED
UNIFIED HUMAN-FACING UX             NOT ESTABLISHED
HUMAN CLAIM AUTHORITY               PRESENT
```

Diese Grenze gilt weiterhin. Die späteren Observatory-Arbeiten erweitern die
...
- Common Carrier–Aperture–Return wurde als verbindende Architektur sichtbar;
- die Grid Grammar wurde kanonisch dokumentiert;
- das Rödelheim Observatory wurde als begrenzte ausführbare Visual-Fixture-
  Familie gebunden;
- sieben benannte Observatory-Frames wurden festgehalten;
- Sternkartenimport, Figurenwahl, Node-/Edge-/Trinity-Inspektion und
  charakteristische Polynome wurden als deklarierte Analyseoperationen
  umgesetzt;
- Green Bridge · Loki bindet korrespondierende Zustände zweier Schichten;
- Closure Transit macht TQR, QRT, HRT und Comparator-Rollen sichtbar;
- Tessarec · Root Space · Iota Pearl verbindet lokalen Träger, Schichtwahl,
  gerichteten Schnitt, Apertur und periodische Adresse;
- Abschlussvisuals übersetzen diese Architektur in Console-, Labor-, Field-
  Art- und Nautilus-Ansichten.

Diese Arbeiten sind mehr als lose Bilder: Sie sind ausführbare oder gebundene
...
Ein Grid ist damit weder automatisch ein physisches Feld noch bloße
Dekoration. Es ist ein deklarierter Adress-, Vergleichs- und
...
- mehrere Sensor- oder Modellansichten derselben Quelle;
- Karten, Gelände, Höhenmodelle und Beobachterpositionen;
- dynamische Zustände, Bahnen, Übergänge und Regime;
- Graphen, Nodes, Kanten, Trinities und Auswahlfiguren;
- modulare, kartesische, polare, gefaltete und geschlossene Grids;
- Himmels-, Sonnen- und planetozentrische Orientierungsframes;
- Sternkataloge, sofern Katalog, Epoche, Koordinaten und Projektion deklariert
  sind;
- lokale Zylinder, periodische Adressen, Helices und Nahtstellen;
- Unterschiede zwischen Primärdaten, Replay, Rekonstruktion und Rückkehr;
- kreative Übersetzungen zwischen Bild, Sprache, Zahl, Klang und räumlicher
  Erfahrung, sofern deren Evidenzstatus getrennt bleibt.

Passende, aber noch nicht vollständig implementierte Erweiterungen sind ein
kataloggebundener Zodiac-/Ekliptikring, ein generalisierter
...
- Repräsentations- und Pipeline-Audits;
- Provenienz- und Claim-Ledger;
- interaktive Forschungsnavigation;
- Lehre zu Frames, Projektionen, inversen Problemen und Modellgrenzen;
- visuelle Hypothesengenerierung;
- kuratorische und künstlerische Forschungsvermittlung.

### Als begrenzte Pilotanwendung prüfbar

- Multisensorik und Sensorfusion;
- digitale Zwillinge;
- Observatoriums- und astronomische Orientierungssoftware;
- Fernerkundung und Kartografie;
- industrielle Zustandsüberwachung;
- Netz- und Systemanalyse;
- Material- und Strukturanalyse;
- Software- und Datenpipeline-Audit;
- Wissens- und Evidenzmanagement;
- Human-AI-Zusammenarbeit bei komplexen Evidenzräumen.

### Nicht einsatzreif

NEXAH ist nicht als autonome Entscheidungs-, Vorhersage- oder
Steuerungskomponente für Medizin, Stromnetze, Verkehr, Sicherheit oder
Raumfahrtführung freigegeben. Solche Anwendungen benötigen eigene Daten,
...
| Stufe | Bedeutung |
|---|---|
| E0 | Ausdruck, Frage und Navigation |
| E1 | exaktes Resultat in einem deklarierten formalen System |
| E2 | synthetisches oder softwaregebundenes Verhalten |
| E3 | kalibrierte lokale Messung |
| E4 | unabhängige Reproduktion |

Der gemeinsame NEXAH-Strang reicht derzeit bis E2. Reale Daten in einzelnen
älteren Untersuchungen erhöhen nicht automatisch die gesamte Architektur auf
E3 oder E4.

Belegt sind eine konsistente Methode, mehrere reproduzierbare formale und
synthetische Resultate, funktionierende Teilkomponenten, dokumentierte
negative Ergebnisse und eine zunehmend belastbare Provenienzarchitektur.

Nicht belegt sind ein universeller Operator, ein neues Naturgesetz, ein
...
- **NEXAHEDRON** ist der primäre Human-facing Research Demonstrator und
  begrenzte Workspace.
- **Rödelheim Observatory** ist eine visuelle, pädagogische und kuratorische
  Instrumentenfamilie innerhalb des größeren NEXAH-Wegs.
- **Outreach** ist eine Multi-Objekt-, Multi-Publikums- und
  Multi-Kanal-Architektur. Es ist gegenwärtig nicht als Kampagne aktiviert.

Ein sinnvolles öffentliches Routing lautet:

```text
PUBLIC ENTRY / EXPERIENCE
  -> NEXAHEDRON
  -> SELECTED OBSERVATORY OR WORK
  -> EVIDENCE ATLAS / SCIENTIFIC SOURCE
  -> EXACT RECORD AND CLAIM BOUNDARY
  -> HUMAN RETURN
```

Visuals, Books, Library Objects und Field Art dürfen dabei Interesse und
...
- keine neue Physik;
- kein Äther- oder Kosmologienachweis;
- kein gelöstes allgemeines Drei-Körper-Problem;
- keine universelle Mathematik;
- keine automatische Wahrheitsmaschine;
- keine autonome Entscheidungsinstanz;
- keine einheitliche Produktionsplattform;
- und kein Ersatz für Fachwissen oder menschliches Urteil.

Metaphern, kosmische Frames, Maschinenbilder und Field Art können als
Erkenntnis- und Orientierungsinstrumente wertvoll sein. Ihre Stärke liegt in
...
öffentlicher und vollständig nachvollziehbarer Vergleich:

1. eine gebundene öffentliche Quelle;
2. zwei oder drei vorab definierte Ansichten;
3. bekannte Unterschiede, die einzelne Ansichten erhalten oder verlieren;
4. ein typisierter Rest und vollständiger Rückweg;
5. etablierte Baselines und ein negativer Kontrollfall;
6. eingefrorener Code, Daten, Parameter und Metriken;
7. unabhängige Prüfung;
8. eine vorab bestimmte Erfolgs-, Negativ- und Unentscheidbarkeitsgrenze.

Damit ließe sich prüfen, ob NEXAH gegenüber einer gewöhnlichen Analyse einen
...
> NEXAH ist ein evidenzgebundenes Orientierungssystem, das untersucht, was von  einer Quelle erhalten bleibt, verloren geht, hinzugefügt wird oder offenbleibt, wenn sie durch begrenzte Ansichten dargestellt und verglichen wird.

### Wissenschaftlich

> NEXAH ist eine beobachterbewusste Repräsentations- und
> Evidenz-Rückkehr-Architektur für Identifizierbarkeit,
> Mehransichtenvergleich, typisierte Residuen und Provenienz.

### Öffentlich

> NEXAH macht sichtbar, wie verschiedene Bilder derselben Sache
> zusammenhängen – und wo sie sich unterscheiden, etwas verlieren oder Fragen offenlassen.

### Technisch

> NEXAH ist ein Human-governed, teilweise integriertes Ökosystem aus Semantik, Records, Vergleichsoperatoren, Validatoren, Forschungsprofilen und Human-facing Instrumenten; es ist keine einheitliche Runtime.

## Schluss

Der Kern von NEXAH ist nicht ein einzelnes Grid, Bild, Programm oder Weltmodell.
Der Kern ist eine Disziplin des Übergangs:

```text
TRÄGER BEWAHREN
ANSICHT BENENNEN
TRANSFORMATION OFFENLEGEN
DIFFERENZ TYPISIEREN
PROVENIENZ MITFÜHREN
ZUR QUELLE ZURÜCKKEHREN
MENSCHLICHE ENTSCHEIDUNG ERHALTEN
```

Damit lassen sich wissenschaftliche Modelle, technische Records, Karten,
Himmelsframes, visuelle Instrumente und kulturelle Works in einem gemeinsamen
...
Diese Synthese wurde insbesondere gegen folgende Autoritätsebenen geprüft:

1. Scientific Constitution und Human-Authority-Grenzen;
2. aktuelle Mission-Control-Truth-Surface vom 17. September 2026;
3. NEXAH Framework Front Door und Research Architecture;
4. Desk-01–03-/THE-EYE-Reconciliation vom 8. September 2026 als historische
   Baseline;
5. Capability and Integration Review vom 9. September 2026;
6. wissenschaftlicher Gesamtreport und Grid/Observatory Public Release vom
   17. September 2026;
7. kanonische Grid Grammar, Observatory Session Close und Sealed Comparison
   Method;
8. öffentliche nexah.de Experience und Visitor Guide;
9. die Front-Door-READMEs von NEXAH, NEXAH-Experience, ORION, Science Lab und
   NEXAHEDRON.

Quarantänematerial, ungebundene physikalische Identitätsbehauptungen und rein
assoziative Bilddeutungen wurden nicht als wissenschaftliche Autorität
übernommen.
