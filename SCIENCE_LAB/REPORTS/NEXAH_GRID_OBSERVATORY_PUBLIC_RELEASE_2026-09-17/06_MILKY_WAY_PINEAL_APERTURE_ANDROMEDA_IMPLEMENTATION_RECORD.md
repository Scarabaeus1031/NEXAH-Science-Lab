...
- [Interactive HTML5 instrument](../../EXPORTS/MIWA_PINEAP_AN_DROMEDA.html)
- [Canonical machine-readable record](../../EXPORTS/MIWA_PINEAP_AN_DROMEDA_RECORD.json)
- [Download package](../../EXPORTS/MIWA_PINEAP_AN_DROMEDA_DOWNLOAD.zip)
...
The included
[`MIWA_PINEAP_STAR_MAP_TEMPLATE.csv`](../../EXPORTS/MIWA_PINEAP_STAR_MAP_TEMPLATE.csv)
